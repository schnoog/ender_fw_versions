...
#define STRING_CONFIG_H_AUTHOR "(schnoog, Ender-3.x)" // Who made the changes.
...
#define PREHEAT_2_LABEL       "Level"
#define PREHEAT_2_TEMP_HOTEND 130
