...
#define STRING_CONFIG_H_AUTHOR "(schnoog, Ender-3a1)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.27 }
...
#define Z_PROBE_FEEDRATE_FAST (2060)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW Z_PROBE_FEEDRATE_FAST
#define Z_PROBE_PAUSE_INTERVAL_MS 500 //see also src/module/probe.cpp line 639...
